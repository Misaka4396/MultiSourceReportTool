...
MOCK_PREPRINT_DATA = [
    {
        ...
        "authors": "Alex J. Thompson, Sarah Chen, David Park",
        "date": "2026-07-28",
    ...
    },
    {
        ...
        "authors": "Yuki Tanaka, James Wilson, Priya Patel",
        "date": "2026-07-25",
    ...
    },
    {
        ...
        "link": "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4567890",
        "source": "SSRN",
        "category": "Economics",
    },
    {
        "title": "Quantum Error Correction at Scale: Recent Advances and Remaining Challenges",
        "authors": "John Preskill, Peter Shor, et al.",
        "date": "2026-07-18",
    ...
    },
    {
        ...
        "authors": "Markus Brunnermeier, Hyun Song Shin",
        "date": "2026-07-15",
        ...
        "link": "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4567891",
        "source": "SSRN",
        "category": "Economics",
    },
    {
        "title": "Efficient Fine-Tuning of Large Language Models via Low-Rank Gradient Compression",
        "authors": "Li Wei, Kim Min-Jun, Anna Schmidt",
        "date": "2026-07-10",
        ...
        "link": "https://arxiv.org/abs/2607.10000",
        "source": "arXiv",
        "category": "cs.CL",
    },
]
...
class PreprintFetcher(BaseFetcher):
    ...
    def fetch(
        self, sources: list[str], category: str, keywords: str, max_results: int = 20
