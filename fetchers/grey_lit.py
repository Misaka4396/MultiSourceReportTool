...
MOCK_GREY_DATA = [
    {
        ...
        "authors": "David Atkin, Amit Khandelwal",
    ...
    },
    {
        ...
        "authors": "John S. Davis, Maria Chen, Robert Kim",
    ...
    },
    {
        ...
        "authors": "Leonard Wantchekon, Sarah Brierley",
        "organization": "World Bank",
        "date": "2026-05-15",
        "file_type": "PDF",
    ...
    },
    {
        ...
        "authors": "Michael Greenstone, Esther Duflo",
        "organization": "World Bank",
        "date": "2026-04-20",
        "file_type": "PDF",
    ...
    },
    {
        ...
        "authors": "Emily S. Goldman, Thomas Wright",
        "organization": "RAND Corporation",
        "date": "2026-03-05",
        "file_type": "PDF",
    ...
    },
    {
        ...
        "authors": "Tavneet Suri, Abhijit Banerjee",
        "organization": "World Bank",
        "date": "2026-02-18",
        "file_type": "PDF",
...
class GreyLiteratureFetcher(BaseFetcher):
    ...
    def _parse_page(self, html: str, domain: str) -> list[dict]:
        ...
        items = soup.find_all(
            "div",
            class_=lambda c: c
            and any(w in (c or "").lower() for w in ["result", "publication", "item", "document"]),
        )
        for item in items[:5]:
    ...
    def _get_filtered_mock(self, keywords, domains, file_types, start_date, end_date):
        ...
        for item in MOCK_GREY_DATA:
            ...
            if not domain_match:
                continue
            if file_types and item.get("file_type", "").lower() not in [
                f.lower() for f in file_types
            ]:
                continue
