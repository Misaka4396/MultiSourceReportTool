...
MOCK_BROKERAGE_DATA = [
    {
        "title": "半导体产业链深度报告：AI芯片驱动新一轮景气周期",
        "authors": "中信证券研究部",
        "date": "2026-07-20",
        "rating": "买入",
        ...
        "analyst": "张三, 李四",
        "industry": "电子",
        "supply_chain": "上游：硅片/光刻胶/EDA工具 → 中游：芯片设计/晶圆制造/封测 → 下游：AI服务器/消费电子/汽车电子",
    },
    {
        "title": "新能源汽车2026中期策略：全球化竞争格局重塑",
        "authors": "华泰证券研究所",
        "date": "2026-07-15",
        "rating": "增持",
        ...
        "analyst": "王五",
        "industry": "新能源",
        "supply_chain": "上游：锂/钴/镍矿 → 中游：动力电池/电机电控 → 下游：整车制造/充电桩/换电",
    },
    {
        "title": "医药行业2026年度策略：创新药出海与CXO拐点",
        "authors": "中金公司研究部",
        "date": "2026-06-28",
        "rating": "买入",
        ...
        "analyst": "赵六, 钱七",
        "industry": "医药",
        "supply_chain": "上游：原料药/培养基/色谱填料 → 中游：CDMO/CRO/创新药研发 → 下游：医院/药店/医保支付",
    },
    {
        "title": "消费升级趋势分析：新零售与国货品牌崛起",
        "authors": "招商证券",
        "date": "2026-06-10",
        "rating": "增持",
        ...
        "analyst": "孙八",
        "industry": "消费",
        "supply_chain": "上游：原材料/代工厂 → 中游：品牌运营/渠道分销 → 下游：电商平台/线下零售/消费者",
    },
    {
        "title": "AI应用落地元年：从算力到场景的产业链机遇",
        "authors": "天风证券",
        "date": "2026-07-05",
        "rating": "买入",
        ...
        "analyst": "周九",
        "industry": "电子",
        "supply_chain": "上游：AI芯片/算力基础设施 → 中游：大模型平台 → 下游：行业应用/端侧AI部署",
    },
    {
        "title": "氢能产业链全景图：从制氢到用氢的万亿市场",
        "authors": "国泰君安研究所",
        "date": "2026-05-22",
        "rating": "增持",
        ...
        "analyst": "吴十",
        "industry": "新能源",
        "supply_chain": "上游：可再生能源制氢/电解槽 → 中游：储氢/运氢/加氢站 → 下游：燃料电池汽车/工业用氢",
    },
]
...
class BrokerageFetcher(BaseFetcher):
    ...
    def fetch(
        self, industry: str, rating: str, start_date: str, end_date: str, keywords: str
    ...
    def _get_filtered_mock(self, industry, rating, start_date, end_date, keywords):
        ...
        if keywords:
            ...
            results = [
                r
                for r in results
                if any(kw in (r.get("title", "") + r.get("abstract", "")).lower() for kw in kw_list)
            ]
